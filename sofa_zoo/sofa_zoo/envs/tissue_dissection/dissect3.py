...
def setup_environment(use_wandb: bool = False):
    ...
    env_kwargs = {
        ...
        "reward_amount_dict": {
            ...
            "distance_cauter_border_point": -0.5, #original -10.0
            "delta_distance_cauter_border_point": -1.0, #original -10.0
            "cut_connective_tissue": 15.0, #original 0.5
            "cut_tissue": -2.5, #original -0.1
...
def parse_args():
    ...
    parser.add_argument('--total-timesteps', type=int, default=2000000, help='Total number of timesteps for training')
...
if __name__ == "__main__":
    ...
    print(f"Experiment logged to runs/{run_name}.pth")
